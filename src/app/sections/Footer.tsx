        ...
        <footer id="footer" className='py-24 md:px-22 bg-black/99 text-[#BCBCBC] text-sm py-10 text-center'>
            <div className="container">
                ...
                <nav className='flex flex-col md:flex-row md:justify-center gap-6 mt-6'>
                    ...
                    <a href="/coresystem">Core System</a>
                    <a href="/comments">Voices from the Shadows</a>
                    {/*<a href="/roadmap">Roadmap</a>*/}
                    <a href="/help">Signal Uplink</a>
                </nav>
                <div className='flex justify-center gap-6 mt-6'>
                    <a href="https://twitter.com/exitproto" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://github.com/ExitProtocol/Token" target="_blank" rel="noopener noreferrer">
